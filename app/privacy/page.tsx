    ...
    <section style={{ paddingTop: "clamp(6rem,12vw,9rem)", paddingBottom: "5rem", background: "var(--bg-primary)" }}>
      <div className="section-container" style={{ maxWidth: "780px" }}>
        ...
        {[
          ...
          { title: "5. Your Rights", content: "You have the right to access, correct, delete, or restrict processing of your personal data. You may also withdraw consent at any time. To exercise these rights, contact: hello@akross.ae." },
