...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return { title: `${service.name} Dubai | aKross Information Technology`, description: service.overview.slice(0, 160), alternates: { canonical: `https://akross.ae/services/ai-automation/${serviceSlug}` } };
}
