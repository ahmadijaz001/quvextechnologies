...
export default function AboutPage() {
  return (
    <>
      ...
      {/* Stats */}
      <section style={{ padding: "4rem 0", background: "var(--bg-secondary)", borderBottom: "1px solid var(--border)" }}>
        <div className="section-container">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "1.5rem", textAlign: "center" }}>
            {[
            ...
            {timeline.map((item, i) => (
              <div key={item.year} style={{ display: "flex", gap: "1.5rem", alignItems: "flex-start" }}>
                <div style={{ flexShrink: 0, display: "flex", flexDirection: "column", alignItems: "center", gap: "0.5rem" }}>
                  ...
                  {i < timeline.length - 1 && <div style={{ width: 1, height: "2rem", background: "rgba(0,212,255,0.2)" }} />}
                </div>
      ...
      <section className="section-padding" style={{ background: "var(--bg-tertiary)", borderTop: "1px solid var(--border)" }}>
        <div className="section-container">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "1.5rem" }}>
            {values.map(v => (
              <div key={v.title} style={{ display: "flex", gap: "1rem", padding: "1.75rem", borderRadius: "1rem", background: "var(--card-bg)", border: "1px solid var(--border)" }}>
      ...
      {/* Team */}
      <section id="team" className="section-padding" style={{ background: "var(--bg-primary)", borderTop: "1px solid var(--border)" }}>
        <div className="section-container">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1.5rem" }}>
            {team.map(member => (
              ...
              >
                {/* Avatar placeholder */}
                <div style={{ width: 72, height: 72, borderRadius: "50%", background: "linear-gradient(135deg, #00d4ff20, #7b2fff20)", border: "2px solid rgba(0,212,255,0.2)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 1.25rem", fontFamily: "var(--font-syne), sans-serif", fontWeight: 700, fontSize: "1.5rem", color: "var(--accent-primary)" }}>
